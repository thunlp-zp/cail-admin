  ...
  <div class="className">
    <el-card class="anoCard">
      ...
      <div class="searchDiv">
        ...
        >
        <el-button
          v-if="activeName === 'submit' && list.length > 0"
...
<script>
import { getPageTab2, getGroupByRaceID, getModelExeResult, getRaceModel } from '@/api/table'
export default {
  data() {
    return {
      tableData: [],
  ...
  methods: {
    ...
    _getRaceModel(params) {
      getRaceModel({ params: params }).then(res => {
